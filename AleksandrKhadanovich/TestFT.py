...
class TestParse(unittest.TestCase):
    ...
    def test_detailed_info(self):
        ...
        nlimit = 5
        n, v = rss_reader.out_info(r, nlimit)
        a = rss_reader.detailed_info(n, vrbs=None, js_on=1, date=None, feed=' ', enc='utf-8')
    ...
    def test_detailed_info3(self):
        ...
        nlimit = 1
        n, v = rss_reader.out_info(r, nlimit)
        rss_reader.detailed_info(n, vrbs=None, js_on=1, date=None, feed=' ', enc='utf-8')
    ...
    def test_outinfo2(self, mockstd):
        rss_reader.outinfodate('2021-10-21 22:14:10', nlimit=-1, vrbs=None, js_on=1, enc='utf-8')
    ...
    def test_outinfo3(self, mockstd):
        ...
        n, v = rss_reader.out_info(r, nlimit)
        rss_reader.detailed_info(n, vrbs=None, js_on=1, date=None, feed=' ', enc='utf-8')
        rss_reader.outinfodate('1021-10-21 22:14:10', nlimit=0, vrbs=None, js_on=1, enc='utf-8')
